...
namespace System
{
    public class UriFormatException : FormatException
    {
        ...
        public UriFormatException(string m): base(m) {}
    }
    ...
    public abstract class UriParser
    {
        ...
        static Dictionary<String,UriParser> table;
        ...
        private static void CreateDefaults()
        {
            ...
            var newtable = new Dictionary<string,UriParser>();
        ...
        // *no* check version
        private static void InternalRegister(Dictionary<String,UriParser> table, UriParser uriParser, string schemeName, int defaultPort)
        {
      ...
      //  [SecurityPermission(SecurityAction.Demand, Infrastructure = true)]
        public static void Register(UriParser uriParser, string schemeName, int defaultPort)
        {
            ...
            if (table[lc] != null)
            {
                string msg = String.Format("Scheme '{0}' is already registred.",schemeName);
