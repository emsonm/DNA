...
namespace System.IO
{
    ...
    public class MemoryStream : Stream
    {
            ...
            set
            {
                ...
                if (value != 0)
                {
                    ...
                    if (internalBuffer != null)
                        Array.Copy(internalBuffer, 0, newBuffer, 0, length);
                }
        ...
        public override int Read([In, Out] byte[] buffer, int offset, int count)
        {
            ...
            Array.Copy(internalBuffer, position, buffer, offset, count);
            position += count;
            return count;
        }
        ...
        public virtual byte[] ToArray()
        {
            ...
            if (internalBuffer != null)
                Array.Copy(internalBuffer, initialIndex, outBuffer, 0, l);
            return outBuffer;
        }
